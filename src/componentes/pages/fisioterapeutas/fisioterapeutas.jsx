...
export default function Fisioterapeutas() {
  ...
  const fisioterapeutas = [
    ...
    },
    {
      ...
      telefone: "(11) 97899-1734",
      email: "Rosa.fernandes@email.com",
    ...
    },
    {
      ...
      telefone: "(11) 95899-5034",
      email: "Aline.ribeiroa@email.com",
    ...
    },
    {
      ...
      telefone: "(11) 97799-3013",
      email: "Jonas.Pereira@email.com",
      experiencia: "7 anos de experiência",
      bio: "Especialista em reabilitação ocupacional com foco em qualidade de vida.",
    },
  ];

  const cidades = ["Todas", "São Paulo, SP", "Osasco, sp", "Campinas, SP", "Guarulhos, SP"];
  const especialidades = ["Todas", "Fisioterapeuta Ocupacional"];
  const atendimentos = ["Todos", "Presencial"];
